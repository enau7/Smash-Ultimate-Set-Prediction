...
We need to split our data into a testing set and a training set so we can train our models and evaluate their accuracy. I am going to use a 4:1 ratio, and stratify across our response variable `p1_won`, so we don't develop any unexpected imbalances across our training and testing enviornments.
